...
export default class ShortController extends BaseController<ShortRepository> {
	...
	public async listShorts(request: Request, response: Response<T.Short.Populated[]>) {
	...
	public async listShortsByUsername(request: Request<{ id: string }>, response: Response<T.Short.Populated[]>) {
	...
	public async getShortById(request: Request<{ shortId: string }>, response: Response<T.Short.Populated>) {
	...
	public async likeShort(request: Request<{ id: string }>, response: Response<void>) {
	...
	public async listCommentsByShort(request: Request<{ shortId: string }>, response: Response<T.Comment.Populated[]>) {
	...
	public async deleteShortComment(request: Request<{ commentId: string }>, response: Response<void>) {
	...
	public async likeShortComment(request: Request<{ commentId: string }>, response: Response<void>) {
	...
	public async getCommentById(request: Request<{ commentId: string }>, response: Response<T.Comment.Comment & {
		likes_count: number
	}>) {
