...
export default class Notificator {
    ...
    constructor(repository: NotificationRepository, publication: PublicationsRepository, comment: CommentRepository, short: ShortRepository, story: StoryRepository);
