...
export declare class PublicationController extends BaseController<PublicationRepository> {
    ...
    listPublications(_request: Request, response: Response<PublicationStruct[]>): Promise<void>;
    ...
    getRecommendations(request: Request, response: Response<PublicationStruct[]>): Promise<void>;
